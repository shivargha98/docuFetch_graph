...
import { FolderPathInput } from "../../src/components/folder/FolderPathInput";
...
describe("FolderPathInput", () => {
  it("pre-fills the input with the provided default watched folder on first render", () => {
     ...
     */
    render(
      <FolderPathInput defaultFolder="/home/user/docs" error={null} onSubmit={() => {}} />
    );

    expect(screen.getByLabelText(/watched folder path/i)).toHaveValue("/home/user/docs");
  });
